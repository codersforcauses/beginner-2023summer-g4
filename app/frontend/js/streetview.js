...
function checkStreetViewAvailability(lat, lng) {
    ...
    streetViewService.getPanorama({ preference: "nearest", radius: 20000, location: location, sources: [google.maps.StreetViewSource.GOOGLE, google.maps.StreetViewSource.OUTDOOR]}, (data, status) => {
